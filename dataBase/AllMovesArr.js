module.exports = [
...

  {
    ...
    meta: {
      ...
      mix_turns: null,
      stat_change: null,
      stat_changes: [{ change: 2, stat: "attack" }],
      target: "user",
      index: 142,
    },
  },
...

  {
    ...
    meta: {
      ...
      effect_chance: 30,
      effect_entries:
        "Inflicts regular damage. Has a $effect_chance% chance to make the target flinch. Power is doubled against Pokémon that have used minimize since entering the field.",
      priority: null,
      crit_rate: null,
      drain: null,
      flinch_chance: 30,
...

  {
    ...
    meta: {
      ...
      mix_turns: null,
      stat_change: null,
      stat_changes: [{ change: -1, stat: "defense" }],
      target: "opponent",
      index: 144,
    },
  },
...

  {
    ...
    meta: {
      ...
      mix_turns: null,
      stat_change: null,
      stat_changes: [{ change: -1, stat: "attack" }],
      target: "opponent",
      index: 52,
    },
  },
...

  {
    ...
    meta: {
      ...
      mix_turns: null,
      stat_change: null,
      stat_changes: [{ change: -1, stat: "special - defense" }],
      target: "opponent",
      index: 1,
    },
  },
...

  {
    ...
    meta: {
      ...
      mix_turns: null,
      stat_change: null,
      stat_changes: [{ change: -1, stat: "speed" }],
      target: "opponent",
      index: 16,
    },
  },
...

  {
    ...
    meta: {
      ...
      mix_turns: null,
      stat_change: null,
      stat_changes: [{ change: -2, stat: "speed" }],
      target: "opponent",
      index: 133,
    },
  },
...

  {
    ...
    meta: {
      ...
      effect_chance: 30,
      effect_entries:
        "Inflicts regular damage. Has a $effect_chance% chance to paralyze the target. During rain dance, this move has 100% accuracy. It also has a (100 - accuracy)% chance to break through the protection of protect and detect. During sunny day, this move has 50% accuracy.",
      priority: null,
      crit_rate: null,
      drain: null,
      flinch_chance: null,
...

  {
    ...
    meta: {
      ...
      mix_turns: null,
      stat_change: null,
      stat_changes: [{ change: -2, stat: "defense" }],
      target: "opponent",
      index: 112,
    },
  },

  {
    ...
    meta: {
      ...
      mix_turns: null,
      stat_change: null,
      stat_changes: [{ change: 1, stat: "evasion" }],
      target: "user",
      index: 32,
    },
  },
...

  {
    ...
    meta: {
      ...
      mix_turns: null,
      stat_change: null,
      stat_changes: [{ change: 2, stat: "evasion" }],
      target: "user",
      index: 84,
    },
  },
...

  {
    ...
    meta: {
      ...
      mix_turns: null,
      stat_change: null,
      stat_changes: [{ change: 2, stat: "special - defense" }],
      target: "user",
      index: 4,
    },
  },
